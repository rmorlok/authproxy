...
type ApiSessionInitiateResponse = ApiSessionInitiateSuccessResponse | ApiSessionInitiateFailureResponse;

function isInitiateSessionSuccessResponse(response: ApiSessionInitiateResponse):
