...
| Topic | Reference |
|---|---|
| AWS infrastructure (VPC, EKS, IAM, Route53) | [`deploy/terraform/README.md`](https://github.com/rmorlok/authproxy/blob/main/deploy/terraform/README.md) |
| Terraform state (S3 + DynamoDB) | [`deploy/terraform/bootstrap/README.md`](https://github.com/rmorlok/authproxy/blob/main/deploy/terraform/bootstrap/README.md) |
| In-cluster components (ingress-nginx, cert-manager, external-dns, metrics-server) | [`deploy/charts/bootstrap/README.md`](https://github.com/rmorlok/authproxy/blob/main/deploy/charts/bootstrap/README.md) |
| AuthProxy application chart | [`deploy/charts/authproxy/README.md`](https://github.com/rmorlok/authproxy/blob/main/deploy/charts/authproxy/README.md) |
...
1. **Create the demo namespace + keypair Secrets** (these are
   ...
   [`deploy/kustomize/authproxy-demo/README.md`](https://github.com/rmorlok/authproxy/blob/main/deploy/kustomize/authproxy-demo/README.md)
...
[`deploy/terraform/README.md`](https://github.com/rmorlok/authproxy/blob/main/deploy/terraform/README.md) under
