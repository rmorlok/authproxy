...
queues any active notifications the actor should see.
...
predicates and setup data-source transforms. They receive:
...
as normal connection updates. System-owned labels under `apxy/*` are not
