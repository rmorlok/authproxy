...
func TestRequestLog_PingAndMigrate(t *testing.T) {
	store, _, _ := MustNewBlankRequestLogStore(t)
...
func TestRequestLog_StoreAndGetRecord_RoundTrip(t *testing.T) {
	store, retriever, _ := MustNewBlankRequestLogStore(t)
...
func TestRequestLog_StoreRecords_Batch(t *testing.T) {
	store, retriever, _ := MustNewBlankRequestLogStore(t)
	ctx := context.Background()
...
func TestRequestLog_StoreRecords_EmptyIsNoop(t *testing.T) {
	store, _, _ := MustNewBlankRequestLogStore(t)
...
func TestRequestLog_GetRecord_NotFound(t *testing.T) {
	_, retriever, _ := MustNewBlankRequestLogStore(t)
	_, err := retriever.GetRecord(context.Background(), apid.New(apid.PrefixRequestLog))
	require.ErrorIs(t, err, ErrNotFound)
}

// --- list filter coverage ---

func TestRequestLog_List_FilterByNamespace(t *testing.T) {
	store, retriever, _ := MustNewBlankRequestLogStore(t)
	ctx := context.Background()
...
func TestRequestLog_List_FilterByScalarFields(t *testing.T) {
	store, retriever, _ := MustNewBlankRequestLogStore(t)
	ctx := context.Background()
...
func TestRequestLog_List_FilterByTimestampRange(t *testing.T) {
	store, retriever, _ := MustNewBlankRequestLogStore(t)
	ctx := context.Background()
...
func TestRequestLog_List_LabelSelector(t *testing.T) {
	store, retriever, _ := MustNewBlankRequestLogStore(t)
	ctx := context.Background()
...
func TestRequestLog_List_Ordering(t *testing.T) {
	store, retriever, _ := MustNewBlankRequestLogStore(t)
	ctx := context.Background()
...
func TestRequestLog_List_Pagination_CursorRoundTrip(t *testing.T) {
	store, retriever, _ := MustNewBlankRequestLogStore(t)
	ctx := context.Background()
