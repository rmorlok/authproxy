...
func TestUpdateConnectionForGenerationMigration(t *testing.T) {
	...
	updated, err := db.UpdateConnectionForGenerationMigration(ctx, ConnectionGenerationMigrationUpdate{
		Id:                     connID,
		ConnectorId:            connectorID,
	...
	require.Equal(t, uint64(2), updated.ConnectorGeneration)
