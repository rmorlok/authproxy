...
func TestSchemaSamples(t *testing.T) {
	tests := []struct {
		...
		{name: "migrate connection generation request", ref: "./schema.json#/$defs/ConnectionGenerationMigrationActionRequest", file: "valid-migrate-connection-generation-request.json"},
		{name: "migrate connection generation response", ref: "./schema.json#/$defs/ConnectionGenerationMigrationActionResponse", file: "valid-migrate-connection-generation-response.json"},
