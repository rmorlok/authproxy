...
func TestSchemaSamples(t *testing.T) {
	tests := []struct {
		...
		{name: "initiate params", ref: "./schema.json#/$defs/InitiateParams", file: "valid-initiate-params.json"},
		{name: "initiate failure", ref: "./schema.json#/$defs/InitiateFailureResponse", file: "valid-initiate-failure-response.json"},
		{name: "initiate success", ref: "./schema.json#/$defs/InitiateSuccessResponse", file: "valid-initiate-success-response.json"},
