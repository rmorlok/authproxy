...
type NamespaceJson struct {
	...
	KeyId       *string           `json:"encryption_key_id,omitempty" yaml:"encryption_key_id,omitempty" example:"key_test550e8400abcd"`
...
type SetNamespaceEncryptionKeyRequestJson struct {
	KeyId string `json:"encryption_key_id" yaml:"encryption_key_id" example:"key_test550e8400abcd"`
}
