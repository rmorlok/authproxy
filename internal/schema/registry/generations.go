...
type GenerationLifecycle interface {
	...
	Select(desired, selected any, changesGeneration, hasEditable bool) (meta.GenerationSelection, error)
	Finalize(desired, current, patch any, selectionContext any, explicit bool) (any, error)
}

type generationLifecycle[R, P any] struct{ policy meta.GenerationPolicy[R, P] }

func withGenerations[R, P any](resource ResourceType, policy meta.GenerationPolicy[R, P]) ResourceType {
...
func (g generationLifecycle[R, P]) State(resource any) (meta.GenerationState, error) {
...
func (g generationLifecycle[R, P]) Select(desired, selected any, changesGeneration, hasEditable bool) (meta.GenerationSelection, error) {
...
func (g generationLifecycle[R, P]) Finalize(desired, current, patch any, selectionContext any, explicit bool) (any, error) {
	d, err := generationResource[R](desired)
	if err != nil {
		return nil, err
	}
