...
const rate = Number(__ENV.LOADTEST_K6_RATE || 2);
const preAllocatedVUs = Number(__ENV.LOADTEST_K6_PRE_ALLOCATED_VUS || 4);
const maxVUs = Number(__ENV.LOADTEST_K6_MAX_VUS || 16);
const duration = __ENV.LOADTEST_K6_DURATION || '30s';
