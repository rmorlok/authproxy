...
- [Default-off behaviour](#default-off-behaviour)
- [Signals](#signals)
- [Span coverage](#span-coverage)
- [Metrics catalog](#metrics-catalog)
- [Configuration reference](#configuration-reference)
- [Standard `OTEL_*` env vars](#standard-otel_-env-vars)
- [Label projection](#label-projection)
  - [Where the labels come from](#where-the-labels-come-from)
  - [Two independent allowlists](#two-independent-allowlists)
  - [Value cap](#value-cap)
- [Trace context propagation](#trace-context-propagation)
- [Error and exception capture](#error-and-exception-capture)
- [Sampling](#sampling)
- [Logs and trace correlation](#logs-and-trace-correlation)
- [Service identity](#service-identity)
- [Local dev sample (`grafana/otel-lgtm`)](#local-dev-sample-grafanaotel-lgtm)
...
For the canonical `dev_config/default.yaml` example see [`dev_config/observability/README.md`](../dev_config/observability/README.md).
