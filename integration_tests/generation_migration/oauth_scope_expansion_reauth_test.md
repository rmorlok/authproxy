...
1. Publish generation 2 and script its refresh response to grant only `read`.
2. Migrate the connection to generation 2 through `_migrateGeneration` and wait for
